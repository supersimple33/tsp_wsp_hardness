# MARK: I must live in this directory since I spit out a lot of files
...
problems = glob.glob("../ALL_tsp/Tnm52.tsp")
...
for problem in problems: # TODO: add some multiprocessing
    ...
    if solver._ncount > 52: # Check that we can handle this problem
    ...
    solution = solver.solve(verbose=False) # Uncomment for debugging
