...
\begin{proof}
    ...
    %\textbf{Subcase 1c:} There is another loop connecting two of the sets.
    ...
    %Assume by contradiction that the optimal TSP tour on $P$ is not TSP-separated.
    %WLOG let there be at least four edges connecting $A$ to $B$ and at least two edges connecting $B$ to $C$.
