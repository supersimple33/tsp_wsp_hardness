...
\begin{defn}
    ...
    We say that this WSPD is a \textbf{bindary WSPD} if $\forall A_i; |A_i| = 1 \vee \exists j,k; A_i = A_j \cup A_k$ and the same holds for all $B_i$.
\end{defn}
...
\begin{thm}[There is a better bound]\label{thm:wsp_tsp}
