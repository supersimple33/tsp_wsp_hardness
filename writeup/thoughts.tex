...
\begin{rem*}
    The previous corollary cannot be guaranteed for $s \leq \frac{1}{\sqrt{2}}$
\end{rem*}
\begin{proof}
    If $s \leq \frac{1}{\sqrt{2}}$ a evil problem can be created in euclidean 2d. 
    Consider $A=\{(0,0), (1,1)\}$ and $B=\{(0,1), (1,0)\}$.
    The diameter of each set is $\sqrt{2}$ and distance between the two sets is $1$ making them $\frac{1}{\sqrt{2}}$-well-separated.
    However the optimal TSP tour on $A \cup B$ is $(0,0) \to (0,1) \to (1,1) \to (1,0) \to (0,0)$ which would contradict \Cref{cor:wsp_tsp} if it applied for $s \leq \frac{1}{\sqrt{2}}$.
\end{proof}
