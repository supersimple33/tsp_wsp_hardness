...
\begin{proof}
    ...
    Since $A$ and $B$ are $s$-well-separated we know that $\forall i,j,k; |a_i a_j| \leq \frac{1}{s} |a_i b_k|$. From this we can conclude the following:
    \begin{align*}
        |a_1 b_1| + |a_3 b_3| &\leq |a_1 a_3| + |b_1 b_3| \\
...
\begin{proof}
    ...
    Since $A$ and $B$ are $s$-well-separated we know that $\forall i,j,k; |a_i a_j| \leq \frac{1}{s} |a_i b_k|$. 
...
\begin{proof}
    ...
    Since $C$ and $B$ are $s$-well-separated we know that $\forall i,j,k; |b_i b_j| \leq \frac{1}{s} |b_i c_k|$. 
    From this we can conclude the following:
    \begin{align*}
