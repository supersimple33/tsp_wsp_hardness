...
\begin{thm}
    ...
    Then there exists a optimal hamiltonian path over $P$ which starts at $a' \in A_1$ and ends at $a'' \in A_1$ where no set is ever connected to another set more than twice.
